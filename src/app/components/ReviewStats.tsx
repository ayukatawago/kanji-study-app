...
export default function ReviewStats({ currentGrade }: ReviewStatsProps) {
  ...
  const [studyStats, setStudyStats] = useState<ReturnType<
  ...
  useEffect(() => {
    // Expand by default on sm+ screens
  ...
  const header = (
    <button
      ...
      className="sm:cursor-default w-full flex items-center justify-between"
    >
      <h2 className="text-lg sm:text-2xl font-bold text-gray-800">学習状況</h2>
  ...
  if (!stats || !studyStats) {
    return (
      <div className="bg-white rounded-lg shadow-lg p-4 sm:p-6 mb-4 sm:mb-6">
        {header}
        {!collapsed && (
          <div className="text-gray-500 text-center py-4 sm:py-8 mt-3 sm:mt-4">
            読み込み中...
          </div>
        )}
      </div>
      ...
      {!collapsed && (
        <div className="mt-3 sm:mt-4">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-4 mb-3 sm:mb-6">
            {/* Due Today */}
            <div className="bg-gradient-to-br from-red-50 to-red-100 rounded-lg p-2 sm:p-4 border border-red-200">
              ...
              <div className="text-xs text-red-500">問</div>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg p-2 sm:p-4 border border-blue-200">
              ...
              <div className="text-xs text-blue-500">回</div>
            </div>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg p-2 sm:p-4 border border-purple-200">
              ...
              <div className="text-xs text-purple-500">日</div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-4 gap-2 sm:gap-3">
            <div className="bg-gray-50 rounded-lg p-2 sm:p-3 border border-gray-200">
              <div className="text-xs text-gray-600 mb-1">新規</div>
            ...
            <div className="bg-orange-50 rounded-lg p-2 sm:p-3 border border-orange-200">
              ...
              <div className="text-base sm:text-xl font-bold text-orange-700">
                {studyStats.learning}
              </div>
            </div>

            <div className="bg-blue-50 rounded-lg p-2 sm:p-3 border border-blue-200">
              <div className="text-xs text-blue-600 mb-1">復習</div>
            ...
            <div className="bg-indigo-50 rounded-lg p-2 sm:p-3 border border-indigo-200">
              <div className="text-xs text-indigo-600 mb-1">合計</div>
          ...
          {stats.lastReviewDate && (
            <div className="mt-3 pt-3 sm:mt-4 sm:pt-4 border-t border-gray-200">
              <p className="text-xs sm:text-sm text-gray-600">
                最終復習:{" "}
                {new Date(stats.lastReviewDate).toLocaleString("ja-JP", {
                  year: "numeric",
                  month: "short",
                  day: "numeric",
                  hour: "2-digit",
